...
class AddChildVC: _BaseScrollViewController, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var btnUpdateCheckup: UIButton!
...
extension AddChildVC : UIImagePickerControllerDelegate {
...
extension AddChildVC : RSKImageCropViewControllerDelegate {
...
extension AddChildVC: UITextFieldDelegate { // MARK: UITextFieldDelegate
...
extension AddChildVC : EyeDegreeListDelegate {
...
extension AddChildVC : SRMonthPickerDelegate {
